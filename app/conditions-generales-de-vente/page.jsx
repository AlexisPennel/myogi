    ...
    return (
        <main className={styles.main}>
            ...
            <section tabIndex={0} aria-labelledby='section-4' className={styles.sections}>
                <header className={styles.sections__header}>
                    <h2 id='section-4'>4. Droits d'auteur et Licence d'utilisation</h2>
                </header>
            ...
            <section tabIndex={0} aria-labelledby='section-12' className={styles.sections}>
                ...
                <p>12.1 <strong>Conformément à la loi du 11 Mars 1957 sur les droits d’auteur, Romain MARTIN</strong> conserve les droits de toutes les images prises pendant une séance et à le droit de reproduction pour ses supports de communication.<br /><br />
                    ...
                    Toute utilisation d’une photographie quel qu’en soit l’usage (concours, diffusion, exposition, reproduction, …) faite sans l’accord écrit de <strong>Romain MARTIN</strong> constitue un délit de contrefaçon au sens de l’article L-335-2 de ce même code. Les peines encourues peuvent allier jusqu’à 3 ans d’emprisonnement et 300 000€ d’amende.<br /><br />
