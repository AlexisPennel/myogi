...
const PortfolioHome = () => {
    const altDescriptions = [
        "Photo d'une Nissan GTR R35",
        "Photo d'un chien Akita Inu roux dans l'herbe",
        "Photo d'un chien Akita Inu près d'une fontaine",
        "Photo d'une voiture Ford Mustang",
        "Photo d'un Akita Inu dans une rivière"
    ]
